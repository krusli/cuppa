...
const getGroup = (req, res, groupId) =>
  getPromiseForRequest(req, res, `http://groups:3001/groups/${groupId}`);

const getGroups = (req, res) =>
  getPromiseForRequest(req, res, 'http://groups:3001/groups');
...
const joinGroup = async (req, res, groupId) => {
  ...
  return await getPromiseForRequest(req, res, 
                                    `http://groups:3001/groups/${groupId}/members`, 
                                    'POST', 
